...
void  NavEKF2::calcOutputStatesFast() {
...
void NavEKF2::zeroRows(Matrix24 &covMat, uint8_t first, uint8_t last)
{
    uint8_t row;
...
void NavEKF2::zeroCols(Matrix24 &covMat, uint8_t first, uint8_t last)
{
    uint8_t row;
...
bool NavEKF2::readyToUseGPS(void) const
{
 ...
 */
float NavEKF2::InitialGyroBiasUncertainty(void) const
{
    return 5.0f;
}
...
void NavEKF2::correctQuatStates(Vector3f &errVec)
{
...
float NavEKF2::calcMagHeadingInnov()
{
    // rotate predicted earth components into body axes and calculate
    // predicted measurements
    Matrix3f Tbn_temp;
